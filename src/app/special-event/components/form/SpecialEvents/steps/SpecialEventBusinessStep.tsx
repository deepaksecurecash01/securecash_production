...
import { SpecialEventFormData } from "@/zod/SpecialEventFormSchema";
...
const BUSINESS_FIELDS: FieldConfig<SpecialEventFormData>[] = [
  {
    name: "BusinessName",
    type: "text",
...
const STATE_FIELD: FieldConfig<SpecialEventFormData> = {
  name: "State",
  type: "select",
...
const POSTCODE_FIELD: FieldConfig<SpecialEventFormData> = {
  name: "Postcode",
  type: "text",
  label: "Postcode",
...
interface SpecialEventBusinessStepProps {
  formManager: SpecialEventFormManager;
  theme?: string;
}

const SpecialEventBusinessStep = ({
  formManager,
  theme = "dark",
}: SpecialEventBusinessStepProps) => (
